...
$$ X_k+_N = \sum_{n=0}^{N-1} x_n\cdot e^ {\frac {-2i{\pi}(k+N)n}{N}} = \sum_{n=0}^{N-1} x_n \cdot e^ {\frac {-2i{\pi}kn}{N}} \cdot e^ {-2i{\pi}n} $$

note that $ e^{-2i{\pi}n}=1 $, therefore, we have :

$$ X_k+_N = \sum_{n=0}^{N-1} x_n\cdot e^ \frac {-2i{\pi}(k+N)n}{N} = X_k $$
